...
class Game
{
  public:
    ...
    virtual ~Game() {};
    virtual void Draw3D(GLWindow2 &glWindow, Map &map, SE3<> se3CfromW ) = 0;  /// draw the game for a map
    virtual void Draw2D(GLWindow2 &glWindow, Map &map) {}                      /// draw any 2D overlays needed.
